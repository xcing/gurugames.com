...
class Article extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('ordinal, type, contentId, gameId, showType, commentType', 'numerical', 'integerOnly' => true),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('articleId, ordinal, type, contentId, gameId, showType, commentType', 'safe', 'on' => 'search'),
        );
    }
