<head>
    ...
    <link rel="stylesheet" href="<?= Yii::app()->request->baseUrl; ?>/css/style.css?reload">
    ...
    <!--script src="<?= Yii::app()->request->baseUrl; ?>/js/chart/Chart.js"></script-->
        ...
        $(document).ready(function() {
            ...
            var images = ['bg-batpuck.jpg', '250-7992975589_44466d9815_o.jpg'];
